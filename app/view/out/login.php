...
<button class="btn text-light" type="submit" style="font-size: 20px; background-color: #0099CC;">Login</button>
<p class="align-self-center">or <a href="http://shared-gallery.loc/user_registration">Register</a></p>
</form>
</div>
